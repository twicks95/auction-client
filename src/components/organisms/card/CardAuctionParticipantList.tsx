...
function CardAuctionParticipantList() {
    return (
        <CardShadow className="flex flex-col gap-4 px-4 py-8">
            <div className="flex justify-between items-center">
                <h2>
                    <TextGreyDarken className="text-lg font-medium">Participant List</TextGreyDarken>
                </h2>
            </div>
...
export default CardAuctionParticipantList
